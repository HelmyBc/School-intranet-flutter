...
class Palette {
  ...
  static const Color scaffold = Color.fromRGBO(225, 220, 210, 1);
  // static const Color scaffold = Color(0xFFECE9E9);
  static const Color darkScaffold = Color.fromRGBO(0, 0, 0, 1);
  static const Color secondLevelLight = Colors.white;
  static const Color secondLevelDark = Color.fromRGBO(40, 40, 40, 1);
  ...
  static const scaffoldDark = Color.fromRGBO(0, 0, 0, 1);
